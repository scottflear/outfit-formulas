...
const funnelA: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultScore: 47,
      resultMetrics: [
        { label: 'Hidden Outfits', value: '47 combinations', color: '#F5326D' },
        { label: 'Wardrobe Used', value: '~23%', color: '#6B6B6B' },
        { label: 'Time Lost Weekly', value: '45 min+', color: '#6B6B6B' },
        { label: 'Potential Savings', value: '$1,200/yr', color: '#F5326D' },
      ],
      progressPercent: 100,
    },
    {
...
const funnelB: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultMetrics: [
        { label: 'Your Style Type', value: 'The Body-Forward Dresser', color: '#F5326D' },
        { label: 'Outfit Potential', value: '60+ combinations', color: '#F5326D' },
...
const funnelC: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultScore: 78,
      resultMetrics: [
        { label: 'Your Archetype', value: 'The Reclaimer', color: '#F5326D' },
        { label: 'Outfit Potential', value: '54 combinations', color: '#F5326D' },
...
const funnelD: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultMetrics: [
        { label: 'Style Archetype', value: 'The Authority Dresser', color: '#F5326D' },
        { label: 'Outfit Potential', value: '52+ combinations', color: '#F5326D' },
...
const funnelE: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultMetrics: [
        { label: 'Your Formula Type', value: 'The Comeback Dresser', color: '#F5326D' },
        { label: 'Hidden Outfits', value: '43 combinations', color: '#F5326D' },
...
const funnelF: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultMetrics: [
        { label: 'Formula Type', value: 'The System Builder', color: '#F5326D' },
        { label: 'Outfit Potential', value: '58 combinations', color: '#F5326D' },
...
const funnelG: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultMetrics: [
        { label: 'Pattern Type', value: 'Data-Responsive Dresser', color: '#F5326D' },
        { label: 'Outfit Potential', value: '61 combinations', color: '#F5326D' },
...
const funnelH: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultMetrics: [
        { label: 'Profile Type', value: 'The Investment Dresser', color: '#F5326D' },
        { label: 'Outfit Potential', value: '68+ combinations', color: '#F5326D' },
...
const funnelI: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultMetrics: [
        { label: 'Transformation Type', value: 'Body-Forward Reset', color: '#F5326D' },
        { label: 'Outfit Potential', value: '55 new combinations', color: '#F5326D' },
...
const funnelJ: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultMetrics: [
        { label: 'Expert Assessment', value: 'High-Potential Profile', color: '#F5326D' },
        { label: 'Outfit Potential', value: '49+ combinations', color: '#F5326D' },
...
const funnelK: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultMetrics: [
        { label: 'Blueprint Type', value: 'The Formula Builder', color: '#F5326D' },
        { label: 'Outfit Potential', value: '53 combinations', color: '#F5326D' },
...
const funnelL: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultMetrics: [
        { label: 'Report Sections', value: '7 sections', color: '#F5326D' },
        { label: 'Pages', value: '24-page report', color: '#F5326D' },
...
const funnelM: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultMetrics: [
        { label: 'Challenge Type', value: 'The Reset Program', color: '#F5326D' },
        { label: 'Week 1 Focus', value: 'Foundation formulas', color: '#F5326D' },
...
const funnelN: Funnel = {
  ...
  screens: [
    ...
    },
    {
      ...
      resultMetrics: [
        { label: 'Plan Type', value: 'The Freedom Reset', color: '#F5326D' },
        { label: 'Your Discount', value: '77% OFF', color: '#F5326D' },
